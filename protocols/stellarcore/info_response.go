...
type SorobanInfoResponse struct {
	...
	// // Protocol v23+ only
	// MaxDependentTxClusters uint32 `json:"max_dependent_tx_clusters,omitempty"`

	// // SCP timing settings (Protocol v23+ only)
	// SCP *SCPSettings `json:"scp,omitempty"`
}

// // SCPSettings represents SCP timing configuration (Protocol v23+)
// type SCPSettings struct {
